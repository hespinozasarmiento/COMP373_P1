...
//            System.out.println("maintenanceDatabase: ********** Query " + makeMaintRequestQuery + "\n");
//
...
//            System.err.println("maintenanceDatabase: Threw a SQLException making a maintenance request.");
...
//            System.out.println("maintenanceDatabase: ********** Query " + scheduleMaintenanceAddQuery + "\n");
//
//            //close to manage resources
//            st.close();
//        }
//        catch (SQLException se) {
//            System.err.println("maintenanceDatabase: Threw a SQLException adding a maintenance "
...
//            System.out.println("maintenanceDatabase: ********** Query " + scheduleMaintenanceRemoveQuery + "\n");
//
//            //close to manage resources
//            st.close();
//        }
//        catch (SQLException se) {
//            System.err.println("maintenanceDatabase: Threw a SQLException removing a "
...
//            }
//            System.out.println("maintenanceDatabase: ********** Query " + calcMaintenanceCostQuery + "\n");
//
//            //close to manage resources
//            maintRS.close();
//            st.close();
...
//        }
//        catch (SQLException se) {
//            System.err.println("maintenanceDatabase: Threw a SQLException calculating total "
...
//            System.out.println("useDatabase: ********** Query " + listMaintRequestsQuery + "\n");
//
//            while ( maintRS.next() ) {
...
//        }
//        catch (SQLException se) {
//            System.err.println("useDatabase: Threw a SQLException retreiving list of maintenance "
...
//            System.out.println("useDatabase: ********** Query " + listMaintenanceQuery + "\n");
//
//            while ( maintRS.next() ) {
...
//        }
//        catch (SQLException se) {
//            System.err.println("useDatabase: Threw a SQLException retrieving list of maintenance "
//                    + "from maint_table.");
//            System.err.println(se.getMessage());
//            se.printStackTrace();
//        }
