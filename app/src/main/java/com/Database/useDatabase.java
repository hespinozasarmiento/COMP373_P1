...
//            System.out.println("useDatabase: ********** Query " + usePst + "\n");
//
...
//            System.err.println("useDatabase: Threw a SQLException assigning a facility "
...
//            System.out.println("useDatabase: ********** Query " + getFacilityStartDateQuery + "\n");
//
//            while ( useRS.next() ) {
...
//        }
//        catch (SQLException se) {
//            System.err.println("useDatabase: Threw a SQLException retrieving facility start date "
//                    + "from the use table.");
//            System.err.println(se.getMessage());
//            se.printStackTrace();
//        }
...
//            System.out.println("useDatabase: ********** Query " + listUsageQuery + "\n");
//
//            while ( useRS.next() ) {
...
//        }
//        catch (SQLException se) {
//            System.err.println("useDatabase: Threw a SQLException retrieving list of usage from use table.");
//            System.err.println(se.getMessage());
//            se.printStackTrace();
//        }
//        return null;
...
//            System.out.println("useDatabase: ********** Query " + selectUseAssignments + "\n");
//
...
//        }
//        catch (SQLException se) {
//            System.err.println("useDatabase: Threw a SQLException checking if "
...
//            System.out.println("useDatabase: ********** Query " + vacateQuery + "\n");
//        }
//        catch (SQLException se){
//            System.err.println("useDatabase: Threw a SQLException vacating the facility.");
//            System.err.println(se.getMessage());
//            se.printStackTrace();
//        }
//    }
...
//            System.out.println("useDatabase: ********** Query " + listInspectionsQuery + "\n");
//
//            while ( useRS.next() ) {
...
//        }
//        catch (SQLException se) {
//            System.err.println("useDatabase: Threw a SQLException retrieving "
