...
//
//            //FacilityDetails
//            String addSAtm = "INSERT INTO facility_detail(name, facility_id, number_of_rooms, phone) VALUES(?, ?, ?, ?)";
...
//
//            } catch (SQLException ex) {
//                System.err.println("facilityDatabase: Threw a SQLException saving the facility object.");
...
//            facPst.executeUpdate();
//
//            System.out.println("facilityDatabase: *************** Query " + updateFacilityDetailQuery + "\n");
//
...
//            System.err.println("facilityDatabase: Threw a SQLException updating the phone number in Facility Detail table.");
...
//
//            System.out.println("facilityDatabase: *************** Query " + selectDetailQuery + "\n");
//
//            while ( detRS.next() ) {
...
//        }
//        catch (SQLException se) {
//            System.err.println("facilityDatabase: Threw a SQLException retrieving the Facility object.");
//            System.err.println(se.getMessage());
//            se.printStackTrace();
//        }
//        return null;
...
//
//            System.out.println("facilityDatabase: ********** Query " + removeFacilityUseQuery + "\n");
//            //close to manage resources
//            st.close();
//        }
//        catch (SQLException se) {
//            System.err.println("facilityDatabase: Threw a SQLException removing the Facility from Use table.");
//            System.err.println(se.getMessage());
//            se.printStackTrace();
//        }
//        try {
...
//
//            System.out.println("facilityDatabase: ********** Query " + removeFacilityDetailQuery + "\n");
//            //close to manage resources
//            st.close();
//        }
//        catch (SQLException se) {
//            System.err.println("facilityDatabase: Threw a SQLException removing the Facility Detail from Facility Detail table.");
//            System.err.println(se.getMessage());
//            se.printStackTrace();
//        }
//        try {
...
//
//            System.out.println("facilityDatabase: ********** Query " + removeFacilityQuery + "\n");
//            //close to manage resources
//            st.close();
//        }
//        catch (SQLException se) {
//            System.err.println("facilityDatabase: Threw a SQLException removing the Facility object from Facility table.");
//            System.err.println(se.getMessage());
//            se.printStackTrace();
//        }
//    }
...
//            System.out.println("facilityDatabase: *************** Query " + getAllFacilitiesQuery + "\n");
//
//            Facility newFacility = new FacilityImpl();
//            while ( facRS.next() ) {
...
//        }
//        catch (SQLException se) {
//            System.err.println("facilityDatabase: Threw a SQLException retrieving list of facilities.");
//            System.err.println(se.getMessage());
//            se.printStackTrace();
//        }
//        return null;
